 ...
 */
public class Documentary extends Activity {

    ArrayList<Movie> documentaryMovies ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            while((str = reader.readLine())!=null) {
                ...
                documentaryMovies.add(new Movie(movieId,rating));
            }
        ...
        CustomAdapter customAdapter = new CustomAdapter(documentaryMovies,Documentary.this);
